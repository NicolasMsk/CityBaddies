# Deploiement Cloud Run Job - Enrichissement Marionnaud (via Cloud Build)
...
gcloud builds submit --config=cloudbuild-enrich-marionnaud.yaml --substitutions=_IMAGE_TAG="$REGISTRY/${JOB_NAME}:latest"
