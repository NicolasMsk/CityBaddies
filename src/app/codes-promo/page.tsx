...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    description: 'Tous les codes promo valides chez Sephora, Nocibé, Marionnaud, My-Origines et Notino pour payer ton parfum moins cher. Codes vérifiés régulièrement.',
    alternates: { canonical: `${BASE_URL}/codes-promo` },
    openGraph: {
      title: 'Codes Promo Parfumeries — City Baddies',
      description: 'Tous les codes promo Sephora, Nocibé, Marionnaud, My-Origines et Notino valides du moment',
