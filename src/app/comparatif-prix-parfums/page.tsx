...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: { canonical: `${BASE_URL}/comparatif-prix-parfums` },
    openGraph: {
      title,
      description,
...
export default async function EnseignesMatchPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Comparatif prix parfums — 5 enseignes', item: `${BASE_URL}/comparatif-prix-parfums` },
    ],
  };
