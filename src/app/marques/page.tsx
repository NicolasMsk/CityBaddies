...
export const metadata: Metadata = {
  ...
  description:
    'Toutes les maisons de parfum suivies par City Baddies : Chanel, Dior, Guerlain, Lancôme, YSL… Prix relevés 6 fois par jour chez Sephora, Nocibé, Marionnaud, My-Origines et Notino.',
  alternates: { canonical: `${BASE_URL}/marques` },
  openGraph: {
    title: 'Toutes les marques de parfum comparées | City Baddies',
    description: 'Prix relevés 6 fois par jour chez Sephora, Nocibé, Marionnaud, My-Origines et Notino, maison par maison.',
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mb-14">
            ...
            <p className="text-neutral-400 font-light text-lg max-w-2xl">
              ...
              chez Sephora, Nocibé, Marionnaud, My-Origines et Notino, et l&apos;historique des relevés.
            </p>
          </div>
