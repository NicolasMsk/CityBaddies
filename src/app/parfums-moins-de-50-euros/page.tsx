...
const FAQ = [
  {
    ...
    answer:
      "Oui — à deux conditions : viser les formats 20 à 50 ml plutôt que les grands flacons, et acheter au bon moment, parce que les enseignes font tourner leurs promos en permanence. La liste ci-dessus ne contient que des offres réellement relevées sur les sites de Sephora, Nocibé et Marionnaud, avec la date du relevé. Zéro spéculation.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Tous les prix listés viennent exclusivement des sites officiels de Sephora, Nocibé et Marionnaud — des distributeurs agréés. Ni marketplaces, ni revendeurs parallèles, ni « testeurs » douteux : le parfum pas cher ne doit jamais être un parfum risqué.",
  },
];
        ...
        <div className="relative max-w-3xl mx-auto px-6 pt-28 pb-24">
          ...
          <div className="mb-16">
            ...
            <p className="text-neutral-400 font-light text-lg leading-relaxed max-w-xl">
              ...
              à des prix réellement relevés chez Sephora, Nocibé et Marionnaud. La liste respire
          ...
          <section className="mb-20">
            ...
            <p className="text-neutral-500 text-sm font-light mb-8">
              Clique sur un flacon : tu verras les trois enseignes, toutes les tailles, et l&apos;évolution du prix.
            </p>
