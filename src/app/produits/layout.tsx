...
export const metadata: Metadata = {
  ...
  description:
    'Comparez les prix de vos parfums entre Sephora, Nocibé, Marionnaud, My-Origines et Notino. Prix relevés six fois par jour, chaque contenance, avec historique.',
  alternates: {
