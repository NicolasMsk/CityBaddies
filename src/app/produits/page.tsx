...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  if (category) {
    ...
    if (brand) {
      ...
      description = `Comparez les prix ${brand} en ${categoryName.toLowerCase()} entre Sephora, Nocibé, Marionnaud, My-Origines et Notino. Trouvez le meilleur prix garanti.`;
    } else {
      title = `${categoryName} — Comparateur de Prix`;
      description = `Comparez les prix ${categoryName.toLowerCase()} entre Sephora, Nocibé, Marionnaud, My-Origines et Notino. Offres vérifiées quotidiennement.`;
    }
  } else {
    // Recentré parfums — 5 enseignes suivies (Sephora, Nocibé, Marionnaud, My-Origines, Notino).
    title = 'Tous les Parfums | Comparateur de Prix';
    description = 'Comparez les prix des parfums entre Sephora, Nocibé, Marionnaud, My-Origines et Notino. Chaque contenance, prix relevés six fois par jour, avec historique.';
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-20 text-center max-w-4xl mx-auto">
          ...
          <div className="text-neutral-400 font-light text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
            {/* 5 enseignes suivies (Sephora, Nocibé, Marionnaud, My-Origines, Notino) */}
            <p className="mb-4">
              Comparez les prix entre <span className="text-white">Sephora, Nocibé, Marionnaud, My-Origines et Notino</span>.
            </p>
