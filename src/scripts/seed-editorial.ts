...
const GUIDES: GuideSeed[] = [
  {
    ...
    metaDescription:
      'Notre classement des meilleurs parfums femme, avec les prix réellement relevés chez Sephora, Nocibé et Marionnaud — pas des impressions, des données.',
    heroImageUrl: '/images/baddies_2.png',
    introduction:
      "<p>Les classements de parfums, tout le monde en fait. La différence ici : chaque parfum de cette sélection est suivi par nos relevés de prix, six fois par jour, chez Sephora, Nocibé et Marionnaud. Tu sais donc non seulement <strong>lequel choisir</strong>, mais aussi <strong>où et quand l'acheter</strong>. Cinq monuments, cinq personnalités — et zéro flacon qu'on n'assumerait pas sur notre propre coiffeuse.</p>",
    content:
    ...
    faq: [
      ...
      { question: 'Comment payer ces parfums moins cher ?', answer: "Trois leviers : comparer les trois enseignes à contenance identique (les écarts dépassent parfois plusieurs dizaines d'euros), choisir le format au meilleur prix au millilitre, et acheter dans un creux de l'historique — trois choses que chaque fiche City Baddies affiche." },
    ],
  ...
  },
  {
    ...
    criteria: [
      ...
      'Comparé chez les 3 enseignes (vrai prix vérifiable)',
    ],
    faq: [
  ...
  },
  {
    ...
    criteria: [
      ...
      'Prix comparés chez les 3 enseignes',
    ],
    faq: [
